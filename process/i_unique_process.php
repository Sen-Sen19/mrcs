...
if (isset($data['data']) && !empty($data['data'])) {
    ...
    foreach ($rows as $row) {
        ...
        $air_water_leak_test = isset($row[12]) ? trim($row[12]) : '';
