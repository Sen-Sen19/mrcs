...
<div class="content-wrapper">
    ...
    <div class="col-md-2 d-flex justify-content-center">
            <button class="btn btn-success custom-btn" id="openModalBtn" data-toggle="modal" data-target="#addRecordModal" style="height: 35px; width: 100%;">
                <i class="fas fa-plus mr-2"></i>Add Account
            </button>
        </div>
        <div class="col-md-2 d-flex justify-content-center">
            <button class="btn btn-danger custom-btn" id="deleteBtn" style="height: 35px; width: 100%;">
                <i class="fas fa-trash mr-2"></i>Delete
                            ...
                            <div id="accounts_table_res" class="table-responsive" style="height: 45vh; overflow: auto; display: inline-block; margin-top: 20px; border-top: 1px solid gray;">
        ...
        <div class="modal-content">
            ...
            <form id="editForm">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" id="editEmp_id" name="emp_id" required>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" style="background-color: #007bff; border-color: #007bff; color:white;" onclick="saveChanges()">Save changes</button>
                </div>
            </form>
        </div>
    </div>
