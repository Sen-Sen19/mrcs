...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url: '../../process/fetch_total_shots_section5.php',
            type: 'GET',
            dataType: 'json',
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch('../../process/fetch_section_5.php')
        ...
        document.getElementById('saveChanges1').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_5_first_month.php', {
                method: 'POST',
                headers: {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('saveChanges2').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_5_second_month.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('saveChanges3').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_5_third_month.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
