...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch(`../../process/fetch_section_9.php?full_name=${encodeURIComponent(fullName)}`)
        ...
        document.getElementById('saveChanges1').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_9_first_month.php', {
                method: 'POST',
                headers: {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('saveChanges2').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_9_second_month.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('saveChanges3').addEventListener('click', function () {
            ...
            fetch('../../process/edit_section_9_third_month.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
