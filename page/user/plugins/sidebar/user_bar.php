...
<div class="sidebar">
  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    <li class="nav-item">
      <a href="dashboard.php" class="nav-link <?= ($_SERVER['REQUEST_URI'] == "/mrcs/page/user/dashboard.php") ? 'active' : '' ?>">
        ...
        <li class="nav-item">
          <a href="summary.php" class="nav-link <?= ($_SERVER['REQUEST_URI'] == "/mrcs/page/user/summary.php") ? 'active' : '' ?>">
             <img src="../../dist/img/summary.png" alt="Pagination Icon" class="nav-icon" style="width: 20px; height: 20px;">
            <p>Summary</p>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="masterlist.php" class="nav-link <?= ($_SERVER['REQUEST_URI'] == "/mrcs/page/user/masterlist.php") ? 'active' : '' ?>">
          <img src="../../dist/img/masterlist.png" alt="Pagination Icon" class="nav-icon" style="width: 20px; height: 20px;">
            <p>Masterlist</p>
          </a>
        </li>
