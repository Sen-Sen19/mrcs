...
<div class="modal fade" id="addRecordModal" tabindex="-1" role="dialog" aria-labelledby="addRecordModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content" style="border-color: #007bff;"> <!-- Apply the stroke color here -->
      ...
      <div class="modal-body">
        ...
        <form id="myForm">
          ...
          <div class="col-sm-4">
              ...
              <input type="text" id="emp_id" name="emp_id" class="form-control" autocomplete="off"
            ...
            <div class="col-sm-4">
              ...
              <input type="text" id="department" name="department" class="form-control" autocomplete="off"
                style="margin-bottom: 30px;">
            </div>
